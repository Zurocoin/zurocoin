...
public:
	...
	std::string zurocoind_authorization;
	uint16_t zurocoind_bind_port;
	std::string zurocoind_bind_ip;
	uint16_t zurocoind_remote_port;
	std::string zurocoind_remote_ip;
