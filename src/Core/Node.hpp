...
static const float DB_COMMIT_PERIOD_ZUROCOIND    = 310;  // 5 minutes sounds good compromise
...
public:
	...
	bool on_wallet_sync3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::zurocoind::SyncBlocks::Request &&, api::zurocoind::SyncBlocks::Response &);
	bool on_sync_mempool3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::zurocoind::SyncMemPool::Request &&, api::zurocoind::SyncMemPool::Response &);

	api::zurocoind::GetStatus::Response create_status_response3() const;
	// json_rpc_node
	bool on_get_status3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::zurocoind::GetStatus::Request &&, api::zurocoind::GetStatus::Response &);
	bool on_get_random_outputs3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::zurocoind::GetRandomOutputs::Request &&, api::zurocoind::GetRandomOutputs::Response &);
	bool handle_send_transaction3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::zurocoind::SendTransaction::Request &&, api::zurocoind::SendTransaction::Response &);
	bool handle_check_send_proof3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::zurocoind::CheckSendProof::Request &&, api::zurocoind::CheckSendProof::Response &);
	bool on_getblocktemplate(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::zurocoind::GetBlockTemplate::Request &&r, api::zurocoind::GetBlockTemplate::Response &);
	void getblocktemplate(
	    const api::zurocoind::GetBlockTemplate::Request &, api::zurocoind::GetBlockTemplate::Response &);
	bool on_get_currency_id(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::zurocoind::GetCurrencyId::Request &&, api::zurocoind::GetCurrencyId::Response &);
	bool on_submitblock(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::zurocoind::SubmitBlock::Request &&, api::zurocoind::SubmitBlock::Response &);
	bool on_submitblock_legacy(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::zurocoind::SubmitBlockLegacy::Request &&, api::zurocoind::SubmitBlockLegacy::Response &);
	bool on_get_last_block_header(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::zurocoind::GetLastBlockHeaderLegacy::Request &&, api::zurocoind::GetLastBlockHeaderLegacy::Response &);
	bool on_get_block_header_by_hash(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::zurocoind::GetBlockHeaderByHashLegacy::Request &&, api::zurocoind::GetBlockHeaderByHashLegacy::Response &);
	bool on_get_block_header_by_height(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::zurocoind::GetBlockHeaderByHeightLegacy::Request &&,
	    api::zurocoind::GetBlockHeaderByHeightLegacy::Response &);
...
protected:
	...
	struct LongPollClient {
		...
		api::zurocoind::GetStatus::Request original_get_status;
	};
	...
	class P2PClientZurocoin : public P2PClientBasic {
		Node *const m_node;
...
#endif
	public:
		explicit P2PClientZurocoin(Node *node, bool incoming, D_handler d_handler)
	...
	std::unique_ptr<P2PClient> client_factory(bool incoming, P2PClient::D_handler d_handler) {
		return std::make_unique<P2PClientZurocoin>(this, incoming, d_handler);
	}
	...
	class DownloaderV11 {  // torrent-style sync&download from legacy v1 clients
		...
		std::map<P2PClientZurocoin *, size_t> m_good_clients;  // -> # of downloading blocks
		size_t total_downloading_blocks = 0;
		std::list<P2PClientZurocoin *> m_who_downloaded_block;
		P2PClientZurocoin *m_chain_client = nullptr;
		...
		struct DownloadCell {
			...
			P2PClientZurocoin *downloading_client = nullptr;
	...
	public:
		...
		void on_connect(P2PClientZurocoin *);
		void on_disconnect(P2PClientZurocoin *);
		const std::map<P2PClientZurocoin *, size_t> &get_good_clients() const { return m_good_clients; }
		void on_msg_notify_request_chain(P2PClientZurocoin *, const NOTIFY_RESPONSE_CHAIN_ENTRY::request &);
		void on_msg_notify_request_objects(P2PClientZurocoin *, const NOTIFY_RESPONSE_GET_OBJECTS::request &);
	...
	void sync_transactions(P2PClientZurocoin *);
