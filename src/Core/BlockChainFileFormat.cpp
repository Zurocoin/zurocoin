...
bool LegacyBlockChainReader::import_blockchain2(const std::string &coin_folder, BlockChainState &block_chain) {
	//	std::fstream ts_file("/Users/user/zurocoin/timestamps.txt",
...
void LegacyBlockChainWriter::write_block(const zurocoin::RawBlock &raw_block) {
	zurocoin::BinaryArray ba = seria::to_binary(raw_block);
