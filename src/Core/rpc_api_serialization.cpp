...
void ser_members(zurocoin::SendProof &v, ISeria &s) {
...
void ser_members(api::zurocoind::GetStatus::Request &v, ISeria &s) {
...
void ser_members(api::zurocoind::GetStatus::Response &v, ISeria &s) {
	ser_members(static_cast<api::zurocoind::GetStatus::Request &>(v), s);
...
void ser_members(api::zurocoind::SyncBlocks::Request &v, ISeria &s) {
...
void ser_members(api::zurocoind::SyncBlocks::Response &v, ISeria &s) {
	seria_kv("blocks", v.blocks, s);
	seria_kv("start_height", v.start_height, s);
	seria_kv("status", v.status, s);
}
void ser_members(api::zurocoind::SyncMemPool::Request &v, ISeria &s) {
	if (!s.is_input())
...
void ser_members(api::zurocoind::SyncMemPool::Response &v, ISeria &s) {
...
void ser_members(api::zurocoind::GetRandomOutputs::Request &v, ISeria &s) {
	seria_kv("amounts", v.amounts, s);
	seria_kv("outs_count", v.outs_count, s);
	seria_kv("confirmed_height_or_depth", v.confirmed_height_or_depth, s);
}
void ser_members(api::zurocoind::GetRandomOutputs::Response &v, ISeria &s) { seria_kv("outputs", v.outputs, s); }
void ser_members(api::zurocoind::SendTransaction::Request &v, ISeria &s) {
	seria_kv("binary_transaction", v.binary_transaction, s);
}
void ser_members(api::zurocoind::SendTransaction::Response &v, ISeria &s) { seria_kv("send_result", v.send_result, s); }
...
/*void ser_members(zurocoin::api::walletd::GetBlock::Request &v, ISeria &s) {
        seria_kv("hash", v.hash, s);
        seria_kv("height", v.height, s);
}*/
void ser_members(zurocoin::api::walletd::GetTransaction::Request &v, ISeria &s) { seria_kv("hash", v.hash, s); }
...
void ser_members(zurocoin::api::zurocoind::SubmitBlock::Response &v, ISeria &s) { seria_kv("status", v.status, s); }
...
void ser_members(zurocoin::api::zurocoind::BlockHeaderLegacy &v, ISeria &s) {
	ser_members(static_cast<zurocoin::api::BlockHeader &>(v), s);
