...
bool Node::on_getblocktemplate(http::Client *who, http::RequestData &&raw_request, json_rpc::Request &&raw_js_request,
    api::zurocoind::GetBlockTemplate::Request &&req, api::zurocoind::GetBlockTemplate::Response &res) {
	api::zurocoind::GetStatus::Request sta;
...
void Node::getblocktemplate(const api::zurocoind::GetBlockTemplate::Request &req,
    api::zurocoind::GetBlockTemplate::Response &res) {
...
bool Node::on_get_currency_id(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::zurocoind::GetCurrencyId::Request && /*req*/, api::zurocoind::GetCurrencyId::Response &res) {
	res.currency_id_blob = m_block_chain.get_genesis_bid();
	return true;
}

bool Node::on_submitblock(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::zurocoind::SubmitBlock::Request &&req, api::zurocoind::SubmitBlock::Response &res) {
...
bool Node::on_submitblock_legacy(http::Client *who, http::RequestData &&rd, json_rpc::Request &&jr,
    api::zurocoind::SubmitBlockLegacy::Request &&req, api::zurocoind::SubmitBlockLegacy::Response &res) {
	if (req.size() != 1) {
		throw json_rpc::Error{CORE_RPC_ERROR_CODE_WRONG_PARAM, "Wrong param"};
	}

	api::zurocoind::SubmitBlock::Request other_req;
...
bool Node::on_get_last_block_header(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::zurocoind::GetLastBlockHeaderLegacy::Request &&,
    api::zurocoind::GetLastBlockHeaderLegacy::Response &response) {
...
bool Node::on_get_block_header_by_hash(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::zurocoind::GetBlockHeaderByHashLegacy::Request &&request,
    api::zurocoind::GetBlockHeaderByHashLegacy::Response &response) {
...
bool Node::on_get_block_header_by_height(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::zurocoind::GetBlockHeaderByHeightLegacy::Request &&request,
    api::zurocoind::GetBlockHeaderByHeightLegacy::Response &response) {
	Hash block_hash;
