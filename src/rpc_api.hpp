...
// bool - Bool
// Amount, SignedAmount, Height, Timestamp, UnlockMoment, Difficulty, (u)int - Number. zurocoin does not use fractional
...
//     amounts large than ~91 million cannot be represented exactly in JavaScript and other platforms using IEEE
...
// zurocoin does not use Null, you should specify empty Array as [], empty string as "", empty Object as {}
namespace zurocoin {
namespace api {
...
enum return_code {
	ZUROCOIND_DATABASE_ERROR    = 101,  // We hope we are out of disk space, otherwise blockchain DB is corrupted.
	ZUROCOIND_ALREADY_RUNNING   = 102,
	WALLETD_BIND_PORT_IN_USE    = 103,
	ZUROCOIND_BIND_PORT_IN_USE  = 104,
...
struct GetStatus {
	...
	struct Request {
		...
		std::string
		    lower_level_error;  // Problems on lower levels (like zurocoind errors in walletd status). Empty - no errors
...
// These messages encoded in JSON can be sent via http url /json_rpc3 to zurocoind rpc address:port
...
struct SyncBlocks {  // Used by walletd, block explorer, etc to sync to zurocoind
	...
	struct SyncBlock {  // Signatures are checked by zurocoind so usually they are of no interest
		api::BlockHeader header;
		zurocoin::BlockTemplate bc_header;
		// the only method returning actual BlockHeader from blockchain, not api::BlockHeader
		std::vector<zurocoin::TransactionPrefix> bc_transactions;
...
struct SyncMemPool {  // Used by walletd sync process
	...
	struct Response {
		...
		std::vector<zurocoin::TransactionPrefix> added_bc_transactions;  // New raw transactions in pool
...
void ser_members(zurocoin::api::EmptyStruct &v, ISeria &s);
void ser_members(zurocoin::api::Output &v, ISeria &s);
void ser_members(zurocoin::api::BlockHeader &v, ISeria &s);
void ser_members(zurocoin::api::Transfer &v, ISeria &s);
void ser_members(zurocoin::api::Transaction &v, ISeria &s);
void ser_members(zurocoin::api::Block &v, ISeria &s);
void ser_members(zurocoin::api::Balance &v, ISeria &s);

void ser_members(zurocoin::api::walletd::GetAddresses::Response &v, ISeria &s);
void ser_members(zurocoin::api::walletd::GetViewKeyPair::Response &v, ISeria &s);
void ser_members(zurocoin::api::walletd::CreateAddresses::Request &v, ISeria &s);
void ser_members(zurocoin::api::walletd::CreateAddresses::Response &v, ISeria &s);
void ser_members(zurocoin::api::walletd::GetBalance::Request &v, ISeria &s);
void ser_members(zurocoin::api::walletd::GetBalance::Response &v, ISeria &s);
void ser_members(zurocoin::api::walletd::GetUnspents::Request &v, ISeria &s);
void ser_members(zurocoin::api::walletd::GetUnspents::Response &v, ISeria &s);
void ser_members(zurocoin::api::walletd::GetTransfers::Request &v, ISeria &s);
void ser_members(zurocoin::api::walletd::GetTransfers::Response &v, ISeria &s);
void ser_members(zurocoin::api::walletd::CreateTransaction::Request &v, ISeria &s);
void ser_members(zurocoin::api::walletd::CreateTransaction::Response &v, ISeria &s);
void ser_members(zurocoin::api::walletd::CreateSendProof::Request &v, ISeria &s);
void ser_members(zurocoin::api::walletd::CreateSendProof::Response &v, ISeria &s);
void ser_members(zurocoin::api::walletd::GetTransaction::Request &v, ISeria &s);
void ser_members(zurocoin::api::walletd::GetTransaction::Response &v, ISeria &s);

void ser_members(zurocoin::api::zurocoind::GetStatus::Request &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::GetStatus::Response &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::SyncBlocks::Request &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::SyncBlocks::SyncBlock &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::SyncBlocks::Response &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::SyncMemPool::Request &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::SyncMemPool::Response &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::GetRandomOutputs::Request &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::GetRandomOutputs::Response &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::SendTransaction::Request &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::SendTransaction::Response &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::CheckSendProof::Request &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::CheckSendProof::Response &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::GetBlockTemplate::Request &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::GetBlockTemplate::Response &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::GetCurrencyId::Response &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::SubmitBlock::Request &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::SubmitBlock::Response &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::BlockHeaderLegacy &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::GetLastBlockHeaderLegacy::Response &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::GetBlockHeaderByHashLegacy::Request &v, ISeria &s);
void ser_members(zurocoin::api::zurocoind::GetBlockHeaderByHeightLegacy::Request &v, ISeria &s);
