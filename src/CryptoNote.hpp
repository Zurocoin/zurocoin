...
#define zurocoin_ALLOW_DEBUG_COMMANDS 1
...
void ser(zurocoin::Hash &v, ISeria &s);
void ser(zurocoin::KeyImage &v, ISeria &s);
void ser(zurocoin::PublicKey &v, ISeria &s);
void ser(zurocoin::SecretKey &v, ISeria &s);
void ser(zurocoin::KeyDerivation &v, ISeria &s);
void ser(zurocoin::Signature &v, ISeria &s);

void ser_members(zurocoin::AccountPublicAddress &v, ISeria &s);
void ser_members(zurocoin::SendProof &v, ISeria &s);
void ser_members(zurocoin::TransactionInput &v, ISeria &s);
void ser_members(zurocoin::TransactionOutput &v, ISeria &s);
void ser_members(zurocoin::TransactionOutputTarget &v, ISeria &s);

void ser_members(zurocoin::CoinbaseInput &v, ISeria &s);
void ser_members(zurocoin::KeyInput &v, ISeria &s);

void ser_members(zurocoin::KeyOutput &v, ISeria &s);

void ser_members(zurocoin::TransactionPrefix &v, ISeria &s);
void ser_members(zurocoin::BaseTransaction &v, ISeria &s);
void ser_members(zurocoin::Transaction &v, ISeria &s);

void ser_members(zurocoin::BlockTemplate &v, ISeria &s);
void ser_members(zurocoin::BlockHeader &v, ISeria &s);
void ser_members(zurocoin::ParentBlock &v, ISeria &s);

void ser_members(zurocoin::RawBlock &v, ISeria &s);
void ser_members(zurocoin::Block &v, ISeria &s);
}
